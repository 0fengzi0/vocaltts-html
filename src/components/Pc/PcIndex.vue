        ...
        <div class="glass" >
            <div class="ttsPage" >
                ...
                <div class="ttsPage-right" >
                    <!--合成内容-->
                    <div class="textInput" ><textarea @input="updateTtsText" id="ttsText" maxlength="60"
                    ...
                    <div class="ttsConfig" >
                        <div class="ttsConfig-left" >
                            <div class="setting cantChoose" >
                                ...
                                <input @input="clickVocaPit" class="parameterInput" max="100" min="-100" name="pit" step="10"
                                       type="range" value="0" />
                            </div >
                            <div class="setting" >
                                <span class="parameterName" >语速:</span >
                                <input @input="clickVocaVel" class="parameterInput" max="100" min="-100" name="vel" step="10"
                                       type="range" value="0" />
                            </div >
                            <div class="setting" >
                                <span class="parameterName" >音量:</span >
                                <input @input="clickVocaVol" class="parameterInput" max="100" min="-100" name="vol" step="10"
                                       type="range" value="0" />
                            </div >
                            <div class="setting" >
                        ...
                        <div class="ttsConfig-right" >
                            <div class="ttsPlay" >
                                <div @click="playTts()" id="ttsPlay" >{{ audioStatus == 0 ? '合成中' : audioStatus == 1 ?
                                                                      '播放' : '停止' }}
                                </div >
                                <div @click="downLoadTTSFile()" id="ttsWaveDownload" >
                                    <svg class="icon" height="25" p-id="1976" t="1575004811319"
                                         version="1.1" viewBox="0 0 1024 1024" width="50" xmlns="http://www.w3.org/2000/svg" >
                                        <path
                            ...
                            <div class="ttsDownloadPage" ><a href="http://www.lastdream.net/forum.php?mod=viewthread&amp;tid=1081"
                                                             target="_Blank" >点击下载PC版</a >
                            </div >
                        </div >
                    </div >
                    <!--播放器-->
                    <div class="audio" >
                        <audio @pause="onPause" @play="onPlay" ref="audio" >
                            <source controls preload="none" src="#"
                                    type="audio/wav" />
                            您的浏览器不支持音频播放。
                        </audio >
                    </div >
