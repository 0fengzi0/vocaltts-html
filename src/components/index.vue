        ...
        <div class="glass">
            <div class="ttsPage">
                ...
                <div class="ttsPage-right">
                    <div class="textInput"><textarea id="ttsText" maxlength="60" placeholder="请输入要合成的文本" @input="updateTtsText"></textarea></div>
                    <div class="ttsConfig">
                        <div class="ttsConfig-left">
                            <div class="setting cantChoose">
                                <span class="parameterName">语调:</span>
                                <input class="parameterInput" type="range" name="pit" step="10" min="-100" max="100" value="0" @input="clickVocaPit" />
                            </div>
                            <div class="setting">
                                <span class="parameterName">语速:</span>
                                <input class="parameterInput" type="range" name="vel" step="10" min="-100" max="100" value="0" @input="clickVocaVel" />
                            </div>
                            <div class="setting">
                                <span class="parameterName">音量:</span>
                                <input class="parameterInput" type="range" name="vol" step="10" min="-100" max="100" value="0" @input="clickVocaVol" />
                            </div>
                            <div class="setting">
...
export default {
    ...
    methods: {
        ...
        // 更新验证码
        updatevcode() {
            this.vcodeImgUrl = this.config.serviceApi + 'vocaltts/synth/getvcode?app=web&uid=' + this.config.appid + '&time=' + new Date().getTime();
        },
        ...
        getConfig() {
            ...
            this.axios
                ...
                .catch(function(res) {
                    console.log(res);
                    that.msgModal = { title: '访问出错', msg: '配置文件不存在' };
                    that.msgModalShow = true;
                });
        }
    }
