<template >
    <div id="page" >
        ...
        <!--弹窗提醒-->
        <promptModel v-show="msgModalShow" @close-prompt='closePrompt' :modelTitle="msgModal.title"
                     :modelMsg="msgModal.msg" ></promptModel >
        <!--验证码弹窗-->
        <vaptchaModel v-show="vcodeModalShow" @return-token="closeVaptcha" ></vaptchaModel >
        <!--公告通知栏-->
        <Notice ></Notice >
    </div >
</template >
